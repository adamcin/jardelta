...
public final class Name implements Serializable, Comparable<Name> {
    ...
    /**
     * Return a {@link net.adamcin.jardiff.core.Name} for the provided normalized, relative path value. A value is
     ...
     * @return a {@link net.adamcin.jardiff.core.Name} for the provided value
