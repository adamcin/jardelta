...
import net.adamcin.jardiff.core.manifest.ManifestRefinementStrategy;
import net.adamcin.jardiff.core.mavenmeta.MavenMetaRefinementStrategy;
import net.adamcin.jardiff.core.osgi.header.HeaderRefinementStrategy;
import net.adamcin.jardiff.core.osgi.ocd.MetaTypeRefinementStrategy;
import net.adamcin.jardiff.core.osgi.scr.ScrRefinementStrategy;
